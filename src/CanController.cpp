...
void CanController::startSceExecutionButton_Click(const std::string& mechFile, const std::string& bindingFile)
{
	// 1. Load Mechs
...
void CanController::saveSceExecSettings_Click(const std::string& mechFile, const std::string& bindingFile) {
...
void CanController::sceExecStopAllMech_Click(const std::string& stopFile) {
	runningScenario = false;
...
void CanController::executeAllCommandsSilent() {
...
void CanController::executeAllCommandsSilentThread() {
...
void CanController::executeAllCommands() {
	std::thread executionThread([this]() {
...
void CanController::executeAllCommandsThread() {
	runningScenario = true;
	for (int i = 0; i < scenarioBuilder->commandQueue.size(); i++) {
		if (!runningScenario) break; // ���������, �� ������ �� ������ "����������"
