...
std::vector<uint8_t> Tensometer::StructToVector(const USBHIDFrame& frame)
{
    std::vector<uint8_t> data(sizeof(USBHIDFrame));
    memcpy(data.data(), &frame, sizeof(USBHIDFrame));
    return data;
}
void Tensometer::CallbackTensometerAnswer(_CAN_Ask_Channel* pChannel, uint32_t* pData) {
    if (callbackTensometerAnswer) {
        callbackTensometerAnswer(pChannel, pData);
    }
};
void Tensometer::SetCallbackTensometerAnswer(const Tensometer_Callback_ANSWER_Delegate& callback) {
    callbackTensometerAnswer = callback;
}

Tensometer::Tensometer(uint8_t _NumBoard) {
    NumBoard = _NumBoard;
...
void Tensometer::SetHidDevice(HidDevice* hidDevice) { pHidDevice = hidDevice; }

void Tensometer::TensometerParsing(USBCANFrame *pUSBCANFrame) {
...
void Tensometer::AskTensometerStatus() {
...
void Tensometer::TensometerCalibrVIn() {
    pAskMess->AskModuleSystem = 10;
    pAskMess->AskModuleType = 51;
    pAskMess->AskChannelNumber = 0;
...
void Tensometer::TensometerCalibrPhoto() {
    pAskMess->AskModuleSystem = 10;
    pAskMess->AskModuleType = 51;
    pAskMess->AskChannelNumber = 0;
    pAskMess->AskType = CAN_Ask_CMD_Mod;
...
void Tensometer::TensometerCMDMod(uint16_t* pFTensoMedian, uint16_t* pFTensoExp, uint16_t* pFTensoAverage, 
...
void Tensometer::TensometerCMDTenso(bool* pTensoChannelOk, TensoDataRate* pTensoDataRate, TensoGain* pTensoGain) {
...
void Tensometer::TensometerCMDTermo(bool* pTensoChannelOk, uint8_t* pTermoDatarate, uint8_t* pTermoGain) {
    Byte8BitMask b8TmpData = { 0 };
    pAskMess->AskModuleSystem = 10;
    pAskMess->AskModuleType = 51;
...
void Tensometer::TensometerClearZero(bool* pTensoChannelOk) {
    pAskMess->AskModuleSystem = 10;
    pAskMess->AskModuleType = 51;
    if ((eNumChannel == Channel1_Tenso_0) || (eNumChannel == Channel2_Tenso_1) || (eNumChannel == Channel3_Tenso_2) || (eNumChannel == Channel4_Tenso_3))
    {
...
void Tensometer::TensometerCalibrWeight(bool* pTensoChannelOk) {
    pAskMess->AskModuleSystem = 10;
    pAskMess->AskModuleType = 51;
    if ((eNumChannel == Channel1_Tenso_0) || (eNumChannel == Channel2_Tenso_1) || (eNumChannel == Channel3_Tenso_2) || (eNumChannel == Channel4_Tenso_3))
    {
...
void Tensometer::TensometerShowResult(_CAN_Ask_Channel* pChannel, uint32_t* pData) {
    *pData = u32OUT_COM;		
    *pChannel = RessAsk_Channel;
}

void Tensometer::TensometerStartCh(_CAN_Ask_Channel* pChannel) {
    pAskMess->AskModuleSystem = 10;
    pAskMess->AskModuleType = 51;
...
void Tensometer::TensometerNoiseReset() {
    pAskMess->AskModuleSystem = 10;
    pAskMess->AskModuleType = 51;
...
void Tensometer::TensometerZeroDriftReset() {
    pAskMess->AskModuleSystem = 10;
    pAskMess->AskModuleType = 51;
    pAskMess->AskChannelNumber = ChannelOff;
    pAskMess->AskType = CAN_Ask_CMD_Mod;
...
void Tensometer::TensometerAskSensorChannel(_CAN_Ask_Channel* pChannel) {
    pAskMess->AskModuleSystem = 10;
    pAskMess->AskModuleType = 51;
...
void Tensometer::SetCANControlTensometer(const _CAN_Ask& pCan_Ask)
{
    USBCANFrame NewUSBCANFrame = { 0 };
